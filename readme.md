...
Plugin ini berdasarkan plugin Social-feed yang dibuat oleh https://github.com/pavelk2/social-feed
...
$('.social-feed-container').socialfeed({
    ...
    // WEIBO
    weibo:{
        access_token: 'YOUR_WEIBO_ACCESS_TOKEN',    // string : "Access token. Weibo access token"
        app_key : 'YOUR_WEIBO_APP_KEY',             // String : Weibo app key
        method: 'statuses/friends_timeline.json',   // String : weibo method. see http://open.weibo.com/wiki/API%E6%96%87%E6%A1%A3_V2/en#Weibo_API
    ...
    callback: function(data) {                          //Function: This is a callback function which is evoked when all the posts are collected and displayed
        console.log("All posts collected!");
    },
    onRenderTemplate: function(template, data) {                          //Function: This is a callback function when each data rendered as HTML
        console.log("All posts collected!");
    }
});
````
